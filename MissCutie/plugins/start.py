...
from MissCutie.misc import SUDOERS, _boot_
from MissCutie.plugins.playlist import del_plist_msg
from MissCutie.plugins.sudoers import sudoers_list
...
from MissCutie.utils.formatters import get_readable_time
        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/MissCutie_Support) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
            ...
            key = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="• sᴜᴩᴩᴏʀᴛ •", url="https://t.me/MissCutie_Support"
                        ),
                    ],
                ]
            )
